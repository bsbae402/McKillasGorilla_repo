...
static const wstring	LEVEL1START10 = L"Lili: The team goes free and the leader takes the bullets. I'm glad I'm not you.";
...
static const wstring	LEVEL1MONEY5 = L"Rebelle: I know who needs it, and it's not us. Now, to donate money, I just have to press \n the ESCAPE Key to pause and go to the donate screen. The more money I donate, the higher score we get. See? Sometimes, doing what's right is rewarded.";
static const wstring	LEVEL1MONEY6 = L"Henry: Ugh. Why are we friends with you again?";
static const wstring	LEVEL1MONEY7 = L"Lili: Just a moment there! Sure. You could give the money away. Or maybe you could put it \n to good use.";
static const wstring	LEVEL1MONEY8 = L"Rebelle: Oh?";
static const wstring	LEVEL1MONEY9 = L"Lili: Just go to the upgrade page in the pause screen, and I can sell you some tools for \n boosting your Attack, Defense, and Speed.";
static const wstring	LEVEL1MONEY10 = L"If you have the money, just select an upgrade. To use it, you can then hit CTRL W to increase your attack power, CTRL A to increase your defense, and CTRL S to increase your speed.";
static const wstring	LEVEL1MONEY11 = L"Rebelle: Why do I need to pay you for this? Aren't you supposed to help me?";
static const wstring	LEVEL1MONEY12 = L"Lili: Well, yeah, but I need the dough to cover some expenses. You get it. Right?";
static const wstring	LEVEL1MONEY13 = L"Rebelle: Hmm. You're not trying to do what Smithy did to us earlier, are you, Miss \n Con-Artist of the team?";
static const wstring	LEVEL1MONEY14 = L"Lili: Heavens no! Oh, but just a disclaimer, Lili Rivera is not responsible for any \n sudden deactivation of upgrades in the field of battle. All sales are final!";
...
static const wstring	MISCA2 = L"Lili: And if you'd like to attack before they do, I'm sure they'd appreciate the challenge.";
static const wstring	MISCB1 = L"Henry: Come on, Rebelle, just think of all the great shooting games that exist. Do any of \n them make you care about your enemies? Just kill 'em and leave. And yes, I know none of those games exist here in 1909, but I still know they're more fun.";
...
static const wstring	MISCE1 = L"Lili: Elora, this is your conscience. Don't use your safety ability. Kill your enemies to keep \n them from coming after you and your friends, particularly Lili, the smartest and cutest friend you'll ever have.";
